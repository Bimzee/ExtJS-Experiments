...
Ext.define('Sch.model.Range', {
     ...
     */
    clsField        : 'Cls',
    /* @cfg {String} durationField The name of the field that defines the duration. Defaults to "Duration".
     */
    ...
    setStartDate : function(date, keepDuration) {
         ...
         */
        this.set(this.durationField, this.getDuration(date, endDate));
        /*
    ...
    /*
     * @method getDuration
     * find the difference b/w start and end date
     * @param {Date} startDate The new start date
     *  @param {Date} EndDate The new EndDate date
     */
    ...
    setEndDate : function(date, keepDuration) {
         ...
         * Custom Implementation Start
         */
        this.set(this.durationField, this.getDuration(startDate, date));
        /*
         * Custom Implementation End
         */
